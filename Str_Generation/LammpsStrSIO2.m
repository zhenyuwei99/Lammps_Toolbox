function [varargout] = LammpsStrSIO2(varargin)
%% Description
% function [varargout] = LammpsStrSIO2(data_cell,pbc,bond_arg,r_cut)
%
% Input:
%
...
atom_charge         =   1.5 .* atom_type - 2;      % Si: 0.7710.   N: -0.57825. Unit: e
atom_mass           =   [15.999400 28.085501];                % N: 14.0067. Si: 28.085501. Unit: g/mol
atom_name           =   ["O","Si"];
%% Setting Variables
